...
const Qwik = component$<Props>((props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 272">
    <path
      fill="#18B6F6"
    ...
    <path
      fill="#FFF"
      d="M182.746 118.763 82.353 9.358l14.266 85.695-25.55 24.773L175.08 223.065l-9.368-85.696z"
    />
  </svg>
));
